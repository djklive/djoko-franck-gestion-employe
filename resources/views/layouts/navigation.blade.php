        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('position-histories.index')" :active="request()->routeIs('position-histories.*')">
                        📋 Historique
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <!-- <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('position-histories.index')" :active="request()->routeIs('position-histories.*')">
                    📋 Historique
                </x-responsive-nav-link>
            </div>
